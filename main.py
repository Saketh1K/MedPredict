...
maternal_model = pickle.load(open(r"C:\Users\saket\Downloads\maternal_care-main\maternal_care-main\notebook\finalized_maternal_model.sav", 'rb'))

# Load fetal health model
fetal_model = pickle.load(open(r"C:\Users\saket\Downloads\maternal_care-main\maternal_care-main\notebook\fetal_health_classifier.sav", 'rb'))
